...
import { Cloud, Clock, TrendingUp, Users, CheckCircle, ArrowRight, Zap, Brain, Rocket, BookOpen } from "lucide-react";
...
const pillars = [
  {
    ...
    features: [
      "Gestionale cantieri e documenti in tempo reale",
      "Sicurezza e adempimenti normativi automatizzati",
      "Back-office in outsourcing: fatturazione, buste paga, adempimenti",
  ...
  },
  {
    ...
    features: [
      "Risponditore automatico con AI conversazionale",
      "Qualificazione lead e booking appuntamenti",
      "Generazione preventivi e documenti automatizzata",
      "Follow-up intelligente su pipeline di vendita",
  ...
  },
  {
    ...
    features: [
      "Campagne ads gestite e ottimizzate dall'AI",
      "Landing page e funnel di conversione personalizzati",
      "Metodo di vendita ibrido: AI + persone",
      "Tracking completo: dal click alla vendita chiusa",
      "Zero canone fisso — paghi solo sui risultati",
    ],
    color: "#10B981",
  },
  {
    ...
    features: [
      "Formazione vendita per team tecnici e commerciali",
      "Consulenza strategica su processi e automazione",
      "Assessment aziendale con TalentProfile 360°",
      "Affiancamento operativo sul campo",
      "Workshop personalizzati per il tuo team",
    ],
    color: "#F59E0B",
  },
];
  ...
  <Layout>
    ...
    {pillars.map((p, i) => (
      <section key={i} className={`py-32 px-6 lg:px-12 ${i % 2 === 0 ? "bg-alt" : ""}`}>
        <div className="max-w-[1320px] mx-auto">
          <div className={`grid lg:grid-cols-2 gap-16 items-start ${i % 2 !== 0 ? "direction-rtl" : ""}`}>
            <FadeIn>
              <div>
                ...
                <Link
                  to="/contatti"
                  className="inline-flex items-center gap-2 text-primary font-semibold text-[14px] uppercase tracking-[1.5px] hover:gap-4 transition-all"
                >
      ...
      <div className="max-w-[900px] mx-auto">
        ...
        <FadeIn delay={0.3}>
          <div className="text-center mt-12">
            <Link
              to="/contatti"
              className="shimmer-btn inline-block bg-primary text-primary-foreground font-bold text-[13px] uppercase tracking-[2px] px-12 py-[18px] hover:-translate-y-0.5 hover:shadow-[0_16px_48px_rgba(246,190,9,0.25)] transition-all relative overflow-hidden"
            >
              Richiedi una Demo →
            </Link>
          </div>
